...
$query = mysqli_query($connection, "SELECT * FROM main_user WHERE type = 'patient' AND user_id = '$user_id'");
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="img img-responsive" href="nlanding.php"><h2>Tayamen</h2></a>
                ...
                <div class="item parallax">
                    <div class="container">
                        <div class="row">
                            ...
                            <h1 data-animate="fadeInDown">Click here to appoint now</h1>
                            

                            <div class="col-md-6 col-md-offset-3">
                                <form action="#" method="post" id="frm-landingPage1" class="form">
                                    <a class="btn btn-round btn-success" data-animate="fadeInDown" href="appointment.php?user_id=<?php echo $row['user_id'];?>">Appoint Now</a>
                                </form>
                            <?php endwhile; ?>
                            </div>
