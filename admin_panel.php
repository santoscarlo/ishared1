<?php include "dental_connect.php";
session_start();
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="add_secretary.php"> <i class="menu-icon fa fa-tasks"></i>Add Secretary </a>
                    </li>
                    <li>
                        <a href="admin_nav.php"> <i class="menu-icon fa fa-users"></i>Patient Request </a>
                    </li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="admin_deleted_patient_history.php"> <i class="menu-icon fa fa-trash"></i>Deleted History </a>
                    </li>
