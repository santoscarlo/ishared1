...
<table class="table">
        ...
        <tbody>
            ...
            <tr>
               ...
               <td>
                <a class="btn btn-outline btn-info fa fa-check" href="admin_approved.php?user_id=<?php echo $row['user_id'];?>"></a>
              </td>
               <td>
                <a class="btn btn-outline btn-info fa fa-clock-o" href="pending.php?user_id="></a>
              </td>
               <td>
                <a class="btn btn-outline btn-danger fa fa-trash-o" href="admin_deleted_request.php?user_id=<?php echo $row['user_id'];?>"></a>
              </td>
